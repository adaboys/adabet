...
const packageGameProvidersId = 'game-providers'
...
export default [
  ...
  { path: '/login/web3/:provider', name: 'login.web3', component: page('login-web3'), meta: { layout: 'auth' }, props: true },
  ...
  // game providers
  { path: '/providers/:provider', name: 'provider', component: () => import(/* webpackChunkName: 'packages/[request]' */ `packages/${packageGameProvidersId}/resources/js/pages/provider`) },
  { path: '/providers/:provider/games/:game', name: 'provider.game', component: () => import(/* webpackChunkName: 'packages/[request]' */ `packages/${packageGameProvidersId}/resources/js/pages/game`) },
  ...
  // raffles
  {
    ...
    children: [
      ...
      { path: 'tickets', name: 'raffles.tickets', component: () => import(/* webpackChunkName: 'packages/[request]' */ `packages/${packageRaffleId}/resources/js/pages/raffles/tickets`) }
    ]
  },
  ...
  { path: '/user/account/deposit-internal', name: 'user.account.deposit-internal', component: page('user/account/deposit-internal') },
  ...
  // dashboard
  {
    ...
    children: [
      ...
      { path: 'bonuses', name: 'admin.dashboard.bonuses', component: page('admin/dashboard/bonuses') },
  ...
  {
    path: '/admin/bonuses',
    name: 'admin.bonuses.index',
    redirect: { name: 'admin.bonuses.general' },
    component: page('admin/bonuses'),
    children: [
      { path: 'general', name: 'admin.bonuses.general', component: page('admin/bonuses/general') },
      { path: 'providers', name: 'admin.bonuses.providers.index', component: () => import(/* webpackChunkName: 'packages/[request]' */ `packages/${packageGameProvidersId}/resources/js/pages/admin/bonuses`) },
      { path: 'providers/create', name: 'admin.bonuses.providers.create', component: () => import(/* webpackChunkName: 'packages/[request]' */ `packages/${packageGameProvidersId}/resources/js/pages/admin/bonuses/create`) }
    ]
  },
  ...
  { path: '/admin/add-ons/bundle', name: 'admin.add-ons.bundle', component: page('admin/add-ons/bundle') },
