<template>
  <v-container class="home-page-original-games mt-10">
    <dynamic-games-list
...
export default {
  ...
  computed: {
    ...mapGetters({ games: 'package-manager/getOriginalGames' })
  },
...
//@media screen and (max-width: 576px) {
  .home-page-original-games::v-deep {
    .display-style-card .v-image {
      height: 150px;
    }
  }
//}
