  ...
  <div>
    ...
    >
      <template v-slot:activator>
        <v-btn v-model="menu" color="primary" fab :small="isMobile">
          <v-icon v-if="menu">
            mdi-close
          </v-icon>
          <v-icon v-else>
      ...
      <v-btn fab small color="primary" @click="gameSearchModal = true">
    ...
    <game-search-modal v-if="gameSearchModal" :active="true" @change="gameSearchModal = false" @close="gameSearchModal = false" />
  </div>
</template>
