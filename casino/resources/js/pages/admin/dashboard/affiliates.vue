      ...
      <v-col cols="12" lg="6">
        <v-card class="text-center" :loading="!data['affiliates-commissions-history']">
          ...
          <v-card-text>
            <v-sheet>
              <v-sparkline
                :key="!!data['affiliates-commissions-history']"
        ...
        <v-card :loading="!referrals">
          <v-toolbar>
            ...
            <comparison-period-filter
              ...
              :solo="true"
              class="flex-grow-0"
              @change="loadData('affiliates-referrals-comparison', $event)"
            />
          </v-toolbar>
          <v-card-text>
            <v-row>
              <v-col cols="12" md="6">
                <v-progress-circular
                  ...
                  :color="previousReferrals ? 'primary' : ''"
                >
              ...
              <v-col cols="12" md="6" class="text-center">
                <v-progress-circular
                  ...
                  :color="currentReferrals ? 'primary' : ''"
                >
        ...
        <v-card :loading="!commissionsByStatus">
          <v-toolbar>
            ...
            <comparison-period-filter
              ...
              :solo="true"
              class="flex-grow-0"
              @change="loadData('affiliates-commissions-by-status', $event)"
            />
          </v-toolbar>
          <v-card-text>
            <v-row>
              <v-col cols="12" md="4">
                <v-progress-circular
                  ...
                  :color="pendingCommissionsTotal > 0 ? 'primary' : ''"
                >
              ...
              <v-col cols="12" md="4" class="text-center">
                <v-progress-circular
                  ...
                  :color="approvedCommissionsTotal > 0 ? 'primary' : ''"
                >
              ...
              <v-col cols="12" md="4" class="text-center">
                <v-progress-circular
                  ...
                  :color="rejectedCommissionsTotal > 0 ? 'primary' : ''"
                >
        ...
        <v-card class="text-center" :loading="!commissionsByType">
          <v-toolbar>
            ...
            <period-filter
              ...
              :solo="true"
              class="flex-grow-0"
              @change="loadData('affiliates-commissions-by-type', $event)"
            />
          </v-toolbar>
          <v-card-text>
            <v-simple-table>
