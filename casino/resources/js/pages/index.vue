<template>
  <div>
    <dynamic-template
      :template="html"
      :components="{ Slider, GamesList, ProviderGamesList, ProvidersList, Predictions, PrimaryFooter, ProvablyFair, BonusCards, Features, Raffles, BiggestWin, RecentGames, Search, Social }"
    />
  </div>
</template>
<script>
