...
class AffiliateController extends Controller
{
    ...
    public function commissions(AffiliateCommissionQuery $query)
    {
        $items = $query
            ...
            ->map(function ($commission) {
                $commission->account->user->makeVisible('referrer');
    ...
    public function approve(AffiliateCommission $commission)
    {
        ...
        AccountTransaction::createGeneric($commission->account, GenericAccountTransaction::TYPE_AFFILIATE_COMMISSION, $commission->amount);
