	...
	public override async Task Run(IJobExecutionContext context) {
		var query =
			...
			select new {
				...
				home_halftime_score = _match.home_halftime_score,
				home_fulltime_score = _match.home_fulltime_score,
				away_score = _match.away_score,
				away_halftime_score = _match.away_halftime_score,
				away_fulltime_score = _match.away_fulltime_score,
		...
		foreach (var matchItem in matchItems) {
			...
			switch (ubet.bet_market_name) {
				case MarketConst.MainFullTime: {
					...
					if (matchEnded) {
						var homeWin = (matchItem.home_fulltime_score > matchItem.away_fulltime_score);
						var draw = (matchItem.home_fulltime_score == matchItem.away_fulltime_score);
						var awayWin = (matchItem.home_fulltime_score < matchItem.away_fulltime_score);
				...
				case MarketConst.Totals: {
					...
					var totalScore = matchItem.home_fulltime_score + matchItem.away_fulltime_score;
