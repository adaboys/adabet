...
public class SportWinnerBetRewardTxModelConst {
	...
	public static readonly TxStatus[] SendRewardTxStatusList = new TxStatus[] {
		SportWinnerBetRewardTxModelConst.TxStatus.RequestSubmitToChain,
		SportWinnerBetRewardTxModelConst.TxStatus.SubmitFailed
	};
}
