...
public class UpdateStatus_TennisJob_Betsapi : BaseJob<UpdateStatus_TennisJob_Betsapi> {
	private const string JOB_NAME = nameof(UpdateStatus_TennisJob_Betsapi);

	internal static void Register(IServiceCollectionQuartzConfigurator quartzConfig, AppSetting appSetting) {
		quartzConfig.ScheduleJob<UpdateStatus_TennisJob_Betsapi>(trigger => trigger
	...
	public UpdateStatus_TennisJob_Betsapi(
		AppDbContext dbContext,
		IOptionsSnapshot<AppSetting> snapshot,
		ILogger<UpdateStatus_TennisJob_Betsapi> logger,
